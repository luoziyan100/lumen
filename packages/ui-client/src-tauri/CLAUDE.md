...
- `src/main.rs` — ensure / LaunchAgent 探测 / launchd_* / 注入 / Focused+Reopen;默认窗 `1160×800`(Cursor/Claude 量级略收);`disable_drag_drop_handler` 让前端 HTML5 文件拖放生效(与 Tauri 原生 drop 互斥)
