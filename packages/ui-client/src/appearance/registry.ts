...
export const SKIN_COSMIC_LATTE: SkinDefinition = {
  ...
  backgroundImage: null,
  tokens: t({
    // 极简中性底（cover 玻璃叠在上面；不要冷雾蓝灰 aurora）
    '--canvas': '#16181e',
    '--paper': 'rgba(255, 255, 255, 0.09)',
    '--paper-solid': 'rgba(28, 30, 36, 0.75)',
    '--paper-deep': 'rgba(22, 24, 30, 0.82)',
    ...
    '--ink': '#F0F2F5',
    '--ink-soft': 'rgba(240, 242, 245, 0.88)',
    '--ink-mute': 'rgba(200, 206, 214, 0.60)',
    '--ink-faint': 'rgba(180, 188, 200, 0.38)',
    '--ember': '#8EC0FF',
    '--ember-soft': '#B8D8FF',
    '--ember-tint': 'rgba(142, 192, 255, 0.12)',
    '--moss': '#8AB4A8',
    ...
    '--beam-a': 'rgba(255, 255, 255, 0.45)',
    '--beam-b': 'rgba(140, 190, 255, 0.35)',
    '--beam-c': 'rgba(200, 210, 230, 0.35)',
    ...
    '--surface-recessed': '#14161c',
    '--surface-control': '#202228',
    '--surface-fill': '#2c2e38',
    '--surface-fill-hover': '#383a46',
    '--surface-interact': '#32343e',
  }),
  effects: { aurora: false, overlay: 0, blurPx: 0 },
}
