/**
 * [INPUT]: Kumo Dialog/Button;CREATE_PROJECT_COPY;pickFolder;FolderIcon
 * [OUTPUT]: CreateProjectModal —— 名称 + 可选本机源文件夹
 * [POS]: 新建项目入口;确认后由 App 调 createProject
...
export function CreateProjectModal({
  ...
  return (
    <Dialog.Root open onOpenChange={(o: boolean) => { if (!o) onClose() }}>
      <Dialog className="create-proj-modal" aria-label={CREATE_PROJECT_COPY.title}>
