...
- `openai.ts` — OpenAI 兼容端点:整包 + SSE;DeepSeek V4 thinking 默认 enabled、抬 max_tokens、回灌 reasoning_content、空正文抛错;`resolveOpenAIEndpointUrl` 剥 Base URL 尾部 `/v1` 防双拼 404
