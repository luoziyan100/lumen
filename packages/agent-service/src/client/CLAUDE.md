...
- `agent-client.ts` — LumenClient:submit/continue/subscribe/cancel/list/listProjects/createProject/renameProject/archiveProject/资产 + 事件订阅;自动从 portfile 读端口与 token
